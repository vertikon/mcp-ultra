...
|-------|--------|-------|------------|
| Clean Architecture | ✅ PASSOU | 0.02s | ✓ Estrutura OK |
| go.mod válido | ✅ PASSOU | 0.00s | ✓ go.mod OK |
### ⚙️  Compilação

| Check | Status | Tempo | Observação |
|-------|--------|-------|------------|
| Dependências resolvidas | ✅ PASSOU | 6.62s | ✓ Dependências OK |
| Código compila | ✅ PASSOU | 112.26s | ✓ Compila perfeitamente |
### 🧪 Testes

| Check | Status | Tempo | Observação |
|-------|--------|-------|------------|
| Testes existem | ✅ PASSOU | 0.14s | ✓ 1 arquivo(s) de teste |
| Testes PASSAM | ✅ PASSOU | 40.35s | ⚠ Sem testes (aceitável para templates) |
| Coverage >= 70% | ✅ PASSOU | 6.67s | ✓ Coverage: 100.0% |
### 🔒 Segurança
...
| Check | Status | Tempo | Observação |
|-------|--------|-------|------------|
| Formatação (gofmt) | ✅ PASSOU | 1.61s | ✓ Formatação OK |
...
| Logs estruturados | ✅ PASSOU | 1.26s | ✓ Logs estruturados OK (zap/zerolog/logrus/slog) |
### 🔌 MCP
...
**Gerado automaticamente em:** 2025-10-05 01:33:31
