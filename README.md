...
[![GitHub Issues](https://img.shields.io/github/issues/vertikon/mcp-ultra)](https://github.com/vertikon/mcp-ultra/issues)
[![GitHub Stars](https://img.shields.io/github/stars/vertikon/mcp-ultra?style=social)](https://github.com/vertikon/mcp-ultra/stargazers)
...
git clone https://github.com/vertikon/mcp-ultra.git && cd mcp-ultra
...
make migrate-up
# ou manualmente:
# psql -h localhost -U postgres -d mcp_ultra -f migrations/*.sql
...
# {"status":"healthy","service":"mcp-ultra","version":"1.0.0","timestamp":"..."}
```
...
```bash
# Build da imagem
docker build -t mcp-ultra:latest -f deploy/docker/Dockerfile .
...
# Logs
kubectl logs -f deployment/mcp-ultra -n mcp-ultra

# Scaling
kubectl scale deployment/mcp-ultra --replicas=3 -n mcp-ultra
```
...
- 🐛 Reportar bugs via [Issues](https://github.com/vertikon/mcp-ultra/issues)
...
2. **Clone** seu fork: `git clone https://github.com/seu-usuario/mcp-ultra.git`
...
- [`good first issue`](https://github.com/vertikon/mcp-ultra/labels/good%20first%20issue) - Ideal para iniciantes
- [`help wanted`](https://github.com/vertikon/mcp-ultra/labels/help%20wanted) - Precisamos de ajuda
- [`documentation`](https://github.com/vertikon/mcp-ultra/labels/documentation) - Melhorias na documentação
...
- **Issues**: [GitHub Issues](https://github.com/vertikon/mcp-ultra/issues) - Reporte bugs ou sugira features
- **Discussions**: [GitHub Discussions](https://github.com/vertikon/mcp-ultra/discussions) - Tire dúvidas e compartilhe ideias
- **Pull Requests**: Contribuições são bem-vindas!
- **Email**: rogeriofesta@gmail.com (mantenedor principal)
- **Repositório**: https://github.com/vertikon/mcp-ultra

### Contribuidores

Este projeto é mantido pela comunidade. Agradecemos a todos que contribuem! 🙏

<a href="https://github.com/vertikon/mcp-ultra/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=vertikon/mcp-ultra" />
</a>
...
**[⬆ Voltar ao topo](#-vertikon-mcp-ultra)**

Made with ❤️ by [Vertikon Labs](https://github.com/vertikon) and [Contributors](https://github.com/vertikon/mcp-ultra/graphs/contributors)
