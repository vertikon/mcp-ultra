			...
			AlertingRules: []AlertRule{
				{
					...
					Expression: "mcp_ultra_slo_error_budget_remaining_percent{slo=\"api_availability\"} < 10",
					For:        5 * time.Minute,
					Severity:   "warning",
					...
					Annotations: map[string]string{
						...
						"runbook":     "https://runbooks.mcp-ultra.com/slo/api-availability",
					},
					Enabled: true,
				},
				{
					Name:       "SLOBurnRateHigh",
					Expression: "mcp_ultra_slo_burn_rate{slo=\"api_availability\"} > 14.4",
					For:        2 * time.Minute,
					Severity:   "critical",
					Labels: map[string]string{
						"service":   "mcp-ultra",
					...
					Annotations: map[string]string{
						...
						"runbook":     "https://runbooks.mcp-ultra.com/slo/burn-rate",
					},
					Enabled: true,
				},
			},
			...
			AlertingRules: []AlertRule{
				{
					...
					Annotations: map[string]string{
						...
						"runbook":     "https://runbooks.mcp-ultra.com/slo/latency",
					},
					Enabled: true,
				},
			},
			...
			AlertingRules: []AlertRule{
				{
					...
					Expression: "mcp_ultra_slo_error_budget_remaining_percent{slo=\"grpc_availability\"} < 10",
					For:        5 * time.Minute,
					Severity:   "warning",
					Labels: map[string]string{
						"service":   "mcp-ultra",
					...
					Annotations: map[string]string{
						...
						"runbook":     "https://runbooks.mcp-ultra.com/slo/grpc-availability",
					},
					Enabled: true,
				},
			},
			...
			AlertingRules: []AlertRule{
				{
					...
					Annotations: map[string]string{
						...
						"runbook":     "https://runbooks.mcp-ultra.com/slo/database",
					},
					Enabled: true,
				},
			},
			...
			AlertingRules: []AlertRule{
				{
					...
					Expression: "mcp_ultra_slo_current_value{slo=\"cache_hit_rate\"} < 85",
					For:        10 * time.Minute,
					Severity:   "warning",
					Labels: map[string]string{
						"service":   "mcp-ultra",
					...
					Annotations: map[string]string{
						...
						"runbook":     "https://runbooks.mcp-ultra.com/slo/cache",
					},
					Enabled: true,
				},
			},
			...
			AlertingRules: []AlertRule{
				{
					...
					Expression: "sum(rate(task_processed_total{job=\"mcp-ultra\"}[5m])) * 60 < 800",
					For:        5 * time.Minute,
					Severity:   "warning",
					Labels: map[string]string{
						"service":   "mcp-ultra",
					...
					Annotations: map[string]string{
						...
						"runbook":     "https://runbooks.mcp-ultra.com/slo/throughput",
					},
					Enabled: true,
				},
			},
			...
			AlertingRules: []AlertRule{
				{
					...
					Expression: "mcp_ultra_slo_current_value{slo=\"compliance_accuracy\"} < 99.5",
					For:        5 * time.Minute,
					Severity:   "critical",
					Labels: map[string]string{
						"service":   "mcp-ultra",
					...
					Annotations: map[string]string{
						...
						"runbook":     "https://runbooks.mcp-ultra.com/slo/compliance",
					},
					Enabled: true,
				},
			},
